...
(let ((class '((class color) (min-colors 89)))
      ...
      ;; Moe-theme colors for hacking on helm
  ...
  (custom-theme-set-faces
   ...
   `(helm-buffer-directory ((,class (:foreground ,tron-salad :bold t))))
   `(helm-buffer-process ((,class (:foreground ,tron-violette))))
   `(helm-buffer-saved-out ((,class (:foreground ,red-2 :background ,black-5))))
   `(helm-buffer-size ((,class (:foreground ,tron-orange-pale))))
   `(helm-candidate-number ((,class (:foreground ,blue-3 :background ,white-0))))
   `(helm-ff-directory ((,class (:foreground ,tron-lantern :background nil :bold t))))
   `(helm-ff-excutable ((,class (:foreground ,tron-salad-bright :background nil :bold t))))
   `(helm-ff-file ((,class (:foreground ,tron-teal-super :background nil))))
   ...
   `(helm-header ((,class (:foreground nil :background ,tron-berlin-blue))))
   ...
   `(helm-selection ((,class (:foreground "#000000" :background ,tron-teal-bright))))
   `(helm-selection-line ((,class (:foreground nil :background ,tron-teal-bright))))
   `(helm-source-header ((,class (:foreground ,white-0 :background ,yellow-1 :bold t))))
   `(helm-visible-mark ((,class (:foreground ,magenta-2 :background ,magenta-0))))
   `(helm-M-x-key ((,class (:foreground ,tron-orange))))
